#### Fork of https://github.com/sindresorhus/query-string with pre compiled distribution compatible with browsers of >0.25% usage statistics (@babel/preset-env default)
